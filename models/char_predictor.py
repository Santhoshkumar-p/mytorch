...
class CharacterPredictor(object):
    ...
    def __init__(self, input_dim, hidden_dim, num_classes):
        ...
        self.gru = GRUCell(input_size=input_dim,hidden_size=hidden_dim) # TODO
        self.projection = Linear(in_features=hidden_dim,out_features=num_classes) # TODO
    ...
    def forward(self, x, h):
        ...
        """
        hnext = self.gru.forward(x=x, h_prev_t=h) # TODO
